...
| [`app-bootstrap/`](app-bootstrap/README.md) | Projects the server-resolved account and department into one client-safe startup response. | `ctx.appBootstrapController` / `ctx.remote.appBootstrap` |
