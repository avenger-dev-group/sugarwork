...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'department.dashboard.agenda',
    kind: 'list',
    scope: 'root',
    summary: 'Department-owned schedule cards on the common Dashboard.',
    doc: 'Department-owned schedule cards on the common Dashboard.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'main\' (client-ui-department-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sales-workspace SalesAgenda id \'sales-agenda\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'department.dashboard.agenda\', () => ctx.slots.register(\n      { name: \'department.dashboard.agenda\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-department-workbench/src/client/index.ts:27',
  },
  {
    key: 'department.dashboard.metrics',
    kind: 'list',
    scope: 'root',
    summary: 'Department-owned attention metrics on the common Dashboard.',
    doc: 'Department-owned attention metrics on the common Dashboard.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'main\' (client-ui-department-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sales-workspace SalesMetrics id \'sales-metrics\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'department.dashboard.metrics\', () => ctx.slots.register(\n      { name: \'department.dashboard.metrics\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-department-workbench/src/client/index.ts:29',
  },
  {
    key: 'department.dashboard.tasks',
    kind: 'list',
    scope: 'root',
    summary: 'Department-owned action lists on the common Dashboard.',
    doc: 'Department-owned action lists on the common Dashboard.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'main\' (client-ui-department-workbench), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sales-workspace SalesTasks id \'sales-tasks\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'department.dashboard.tasks\', () => ctx.slots.register(\n      { name: \'department.dashboard.tasks\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-department-workbench/src/client/index.ts:31',
  },
  {
    key: 'main',
    kind: 'keyed',
    ...
    occupants: [
      ...
      'client-ui-department-workbench Dashboard',
      'client-ui-sales-workspace SalesPanel',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models DefaultProviderOnboardingDialog id \'metis\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-department-workbench DashboardIcon',
      'client-ui-sales-workspace SalesNavIcon',
    ],
    replaceRisk: 'none',
