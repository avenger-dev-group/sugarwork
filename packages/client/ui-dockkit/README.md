---
description: "Docking layout kit for the sw web client: a split tree of tabbed panes with invertible operations, planners, a linear history, and the components that render and drive it."
