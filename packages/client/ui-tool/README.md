---
description: "Client Tool presentation plugin for the sw web client: whole-call tree composition, the keyed per-tool view slot, and the built-in atomic tool cards."
