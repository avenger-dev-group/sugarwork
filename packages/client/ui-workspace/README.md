---
description: "Shared Workspace browser and picker plugin for the sw web client: grouped or flat session rows, add/rename/reorder, search, fork, archive, and the directory-flow picking hole."
