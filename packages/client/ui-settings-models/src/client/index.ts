 ...
 * the Models page plus the ordered internal-testing and default-provider
...
import { DefaultProviderOnboardingDialog } from './DefaultProviderOnboardingDialog.tsx'
import type { DefaultProviderOnboardingInjected } from './DefaultProviderOnboardingDialog.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const defaultProviderOnboardingInjected = (): DefaultProviderOnboardingInjected => ({
    controller,
  ...
  ctx.slots.inject('settings.onboarding', () => ctx.slots.register({
    ...
    id: 'metis',
    order: 0,
    inject: defaultProviderOnboardingInjected,
  }, DefaultProviderOnboardingDialog))
}
