---
description: "Scope-grouped read-only plugin inventory tab in Web Plugins settings for the sw web client: agent-preset compositions first, the global plane behind a disclosure, search across both."
