---
description: "Theme and content-font-size settings for the sw web client: --dsw-* token stylesheets, ThemeRuntime state, General settings rows, and the pre-plugin bootstrap."
