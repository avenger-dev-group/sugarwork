---
description: "Settings shell, ownerless copy, and durable product-onboarding namespace for the sw web client: the General section, trigger chrome, and onboarding ledger projection."
