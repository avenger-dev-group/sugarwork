---
description: "The stdio JSON-RPC serving plugin for deployments that let out-of-process SDK clients open sessions and drive agents in a SugarWork runtime."
...
- [SDK application bundle](../../bundle/sdk-app/README.md) — the `sw --profile sdk` application that boots this plugin.
