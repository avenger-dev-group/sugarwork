...
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$SW_HOME` or `~/.sw`. */
  dshHome?: string
...
export interface Config {
  /** Explicit harness home; omitted follows `DSH_HOME`, then `~/.sw`. */
  dshHome?: string
...
export interface Config {
  ...
  path?: string
  /** Harness home used when `path` is omitted; defaults to `$SW_HOME` or `~/.sw`. */
  dshHome?: string
...
export interface Config {
  /** SugarWork home directory exposed as `DSH_HOME`; defaults to `$SW_HOME` or `~/.sw`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** SugarWork config root. Defaults to `$SW_HOME` or `~/.sw`. */
  dshHome?: string
...
export interface Config {
  /** Include the fixed SugarWork identity before the deployment persona (default true). */
