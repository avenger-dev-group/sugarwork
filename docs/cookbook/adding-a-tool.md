...
Reference for the contracts a model-facing tool must satisfy. For workspace wiring, start with the [package checklist](adding-a-package.md). `packages/shell/tool-bash` is the production-grade three-package example.
