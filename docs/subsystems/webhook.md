...
The [GitHub review example](../../apps/cli/config/examples/github-review/cordis.yml) mounts this route on an isolated second WebServer so exposing webhook ingress does not expose the browser API.
