...
export const en = {
  application: 'SugarWork',
  startupFailed: 'SugarWork could not start',
  startupLoading: 'Starting SugarWork…',
...
export const zh = {
  application: 'SugarWork',
  startupFailed: 'SugarWork 无法启动',
  startupLoading: '正在启动 SugarWork…',
  ...
  pluginWindowTitle: 'SugarWork — 桌面插件',
