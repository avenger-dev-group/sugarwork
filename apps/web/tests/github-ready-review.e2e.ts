...
const TITLE = 'Review avenger-dev-group/sugarwork#314'
...
describe.skipIf(MODE === 'record')('web e2e: GitHub ready-for-review', () => {
  ...
  it('isolates ingress and creates a browsable Workspace Session', async () => {
    ...
    const payload = {
      ...
      number: 314,
      repository: { full_name: 'avenger-dev-group/sugarwork' },
      pull_request: {
        title: 'Fix session replay',
        html_url: 'https://github.com/avenger-dev-group/sugarwork/pull/314',
        draft: false,
        user: { login: 'octocat' },
